const updateScript = (queryInterface, Sequelize, script) => {
  const sequelize = queryInterface.sequelize;
    ...
    const script = {
      ...
      description: 'This is a digital PID controller scenario.\r\nSet input, switch topics, and entry parameters for the PID controller. After saving you can change the target value by an appropriate widget.',
      script: 'pwm-pidController',
      configuration: {
          fields: [
              {
                  label: 'Input topic*',
      ...
      language: 'JS',
      icon: 'api/static/icons/scenarios/pidController-pwm.svg'
    };
